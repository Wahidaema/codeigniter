    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <button><a class="btn btn-warning btn-sm" href="http://localhost/codeigniter/addcontactpage">Add Contact Us</a></button>
                ...
                <?php
                     foreach($fetchcontact as $contact){
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $contact->id;?></th>
                        <td><?php echo substr ($contact->heading,0,10);?></td>
                        <td><?php echo substr ($contact->paragraph,0,50);?>...</td>
                        <td><?php echo substr ($contact->name,0,10);?></td>
                        <td><?php echo $contact->email;?></td>
                        <td><?php echo substr ($contact->message,0,50);?>...</td>
                        <td><?php echo substr ($contact->buttoncaption,0,10);?></td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$contact->background;?>"></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editcontact/'.$contact->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/deletecontactpage/'.$contact->id)?>"role="button">Delete</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewcontact/'.$contact->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
