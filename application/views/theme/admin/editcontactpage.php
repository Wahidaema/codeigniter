    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <form action="<?php echo site_url('admin/updatecontactpage/'.$editcontact->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your messag..." id="heading" name="heading"value="<?php echo $editcontact->heading;?>">
                    </div>
                    <div class="row">
                        <label>Paragraph</label>
                        <input type="text" placeholder="  Enter your message..." id="paragraph" name="paragraph"value="<?php echo $editcontact->paragraph;?>">
                    </div>
                    <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your message..." id="name" name="name"value="<?php echo $editcontact->name;?>">
                    </div>
                    <div class="row">
                        <label>E-mail</label>
                        <input type="text" placeholder="  Enter your email..." id="email" name="email"value="<?php echo $editcontact->email;?>">
                    </div>
                    <div class="row">
                        <label>Message</label>
                        <input type="text" placeholder="  Enter your message..." id="message" name="message"value="<?php echo $editcontact->message;?>">
                    </div>
                    <div class="row">
                        <label>Button-Caption</label>
                        <input type="text" placeholder="  Enter your message..." id="button-caption" name="button-caption"value="<?php echo $editcontact->buttoncaption;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($editcontact->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editcontact->background);?>">
                        <?php }?>
                    </div>
