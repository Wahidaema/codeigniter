    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <button><a class="btn btn-warning btn-sm" href="http://localhost/codeigniter/adddessert">Add Dessert</a></button>
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">Button Caption</th>
                        <th scope="col">Action</th>
                    </tr>
                </thead>
                <?php
                     foreach($fetchdessert as $dessert){
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $dessert->id;?></th>
                        <td><?php echo substr ($dessert->recipetitle,0,10);?></td>
                        <td><?php echo substr ($dessert->postby,0,10);?></td>
                        <td><?php echo $dessert->date;?></td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$dessert->image;?>"></td>
                        <td><?php echo substr ($dessert->content,0,50);?>...</td>
                        <td><?php echo substr ($dessert->buttoncaption,0,10);?></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editdessert/'.$dessert->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/deletedessert/'.$dessert->id)?>"role="button">Delete</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewdessert/'.$dessert->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
