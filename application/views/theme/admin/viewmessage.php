...
<head>
    ...
    <title>admin panel View Message</title>
</head>
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your Name..." id="name" name="name"value="<?php echo $viewmessage->name;?>">
                    </div>
                    <div class="row">
                        <label>Email</label>
                        <input type="email" placeholder="  Enter your Email..." id="email" name="email"value="<?php echo $viewmessage->email;?>">
                    </div>
                    <div class="row">
                        <label>Message</label>
                        <input type="text" placeholder="  Enter your message..." id="message" name="message"value="<?php echo $viewmessage->message;?>">
                    </div>
