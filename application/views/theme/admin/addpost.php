    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <form action="<?php base_url()?>savepost" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Recipe-Title</label>
                        <input type="text" placeholder="  Enter your message..." id="recipe-title" name="recipe-title">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your name..." id="post-by" name="post-by">
                    </div>
                    <div class="row">
                        <label>Date</label>
                        <input type="date" placeholder="  Enter your message..." id="input" name="input">
                    </div>
                    <div class="row">
                        <label>Image</label>
                    ...
                    <div class="row">
                        ...
                        <input type="text" placeholder="  Enter your message..." id="equipment" name="equipment">
                    </div>
                    <div class="row">
                        <label>Ingredients</label>
                        <input type="text" placeholder="  Enter your message..." id="ingredients" name="ingredients">
                    </div>
                    <div class="row">
                        <label>Instructions</label>
                        <input type="text" placeholder="  Enter your message..." id="instructions" name="instructions">
                    </div>
