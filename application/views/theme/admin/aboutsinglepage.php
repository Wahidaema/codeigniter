    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <button><a class="btn btn-warning btn-sm" href="http://localhost/codeigniter/addaboutsinglepage">Add About Me</a></button>
                ...
                <?php
                     foreach($fetchaboutsingle as $aboutsingle){
                ?>
                <tbody>
                    <tr>
                    <th scope="row"><?php echo $aboutsingle->id;?></th>
                        <td><?php echo substr ($aboutsingle->authorname,0,10);?></td>
                        <td><?php echo substr ($aboutsingle->content,0,50);?>...</td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$aboutsingle->profile;?>"></td>
                        <td><?php echo substr ($aboutsingle->buttoncaption,0,10);?></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editaboutsingle/'.$aboutsingle->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/deleteaboutsinglepage/'.$aboutsingle->id)?>"role="button">Delete</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewaboutsingle/'.$aboutsingle->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
