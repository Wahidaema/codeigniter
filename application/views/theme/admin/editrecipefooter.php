    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                <h2 class="Header-form">Recipe Footer</h2>
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                <form action="<?php echo site_url('admin/updaterecipefooter/'.$editrecipefooter->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content"value="<?php echo $editrecipefooter->content;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your message..." id="post-by" name="post-by"value="<?php echo $editrecipefooter->postby;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($editrecipefooter->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editrecipefooter->background);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Paragraph</label>
                        <input type="text" placeholder="  Enter your message..." id="paragraph" name="paragraph"value="<?php echo $editrecipefooter->paragraph;?>">
                    </div>
