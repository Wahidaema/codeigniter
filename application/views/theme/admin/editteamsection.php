    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                <h2 class="Header-form">Team Section</h2>
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                <form action="<?php echo site_url('admin/updateteamsection/'.$editteam->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your message..." id="name" name="name"value="<?php echo $editteam->name;?>">
                    </div>
                    <div class="row">
                        <label>Position</label>
                        <input type="text" placeholder="  Enter your message..." id="title" name="title"value="<?php echo $editteam->position;?>">
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content"value="<?php echo $editteam->content;?>">
                    </div>
                    <div class="row">
                        <label>Profile</label>
                        <input type="file" class="photo"name="profile">
                        <?php if($editteam->profile){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editteam->profile);?>">
                        <?php }?>
                    </div>
