        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your message..." id="heading" name="heading" value="<?php echo $viewhdr->heading;?>">
                    </div>
                    <div class="row">
                        <label>Paragraph</label>
                        <input type="text" placeholder="  Enter your message..." id="paragraph" name="paragraph" value="<?php echo $viewhdr->paragraph;?>">
                    </div>
                    <div class="row">
                        <label>Button-Caption</label>
                        <input type="text" placeholder="  Enter your message..." id="button-caption" name="button-caption" value="<?php echo $viewhdr->buttoncaption;?>">
                    </div>
                    <div class="row">
                        <label>Logo-text</label>
                        <input type="text" placeholder="  Enter your message..." id="logo-text" name="logo-text" value="<?php echo $viewhdr->logotext;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <?php if($viewhdr->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewhdr->background);?>">
                        <?php }?>
                    </div>
                </div>
            </div>
