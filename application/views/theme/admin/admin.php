                   ...
                   <table class="table table-bordered table-dark">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo substr ($hdr->heading,0,10);?></td>
                                <td><?php echo substr ($hdr->paragraph,0,50);?>...</td>
                                <td><?php echo substr ($hdr->buttoncaption,0,10);?></td>
                                <td><?php echo substr ($hdr->logotext,0,10);?></td>
                                <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$hdr->background;?>"></td>
                                <td>
                                   <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/edithdr/'.$hdr->id)?>">Edit</a>
                                   <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewhdr/'.$hdr->id)?>">View</a>
                            </tr>   
                            <?php
                            }
                            ?>        
