                ...
                <div class="sidebar-menu">
                   ...
                   <!--end header-->
                        ...
                        <li class="item" id="Recipe">
                            ...
                            <div class="sub-menu">
                                <a href="<?php echo base_url();?>recipeindex">
                                    <i class="fas fa-chess-queen"></i><span>Recipe Index</span>
                                </a>
                                <a href="<?php echo base_url();?>maincourse">
                                    <i class="fas fa-pepper-hot"></i><span>Main Course</span>
                                </a>   
                                <a href="<?php echo base_url();?>dessert">
                                    <i class="fas fa-ice-cream"></i><span>Dessert Section</span>
                                </a>    
                                <a href="<?php echo base_url();?>recipefooter">
                                    <i class="fas fa-bread-slice"></i><span>Another Page</span>
                                </a>  
                            </div>
                        </li> 
                        <!--end recipe section-->
                    ...
                    <li class="item">
                        ...
                        <li class="item">
                            <a href="<?php echo base_url();?>aboutus" class="menu-btn">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo substr ($post->equipment,0,50);?>...</td>
                        <td><?php echo substr ($post->ingredients,0,50);?>...</td>
                        <td><?php echo substr ($post->instructions,0,50);?>...</td>                       
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editpost/'.$post->id)?>"role="button">Edit</a>
