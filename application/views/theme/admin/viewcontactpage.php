        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your messag..." id="heading" name="heading"value="<?php echo $viewcontact->heading;?>">
                    </div>
                    <div class="row">
                        <label>Paragraph</label>
                        <input type="text" placeholder="  Enter your message..." id="paragraph" name="paragraph"value="<?php echo $viewcontact->paragraph;?>">
                    </div>
                    <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your message..." id="name" name="name"value="<?php echo $viewcontact->name;?>">
                    </div>
                    <div class="row">
                        <label>E-mail</label>
                        <input type="text" placeholder="  Enter your email..." id="email" name="email"value="<?php echo $viewcontact->email;?>">
                    </div>
                    <div class="row">
                        <label>Message</label>
                        <input type="text" placeholder="  Enter your message..." id="message" name="message"value="<?php echo $viewcontact->message;?>">
                    </div>
                    <div class="row">
                        <label>Button-Caption</label>
                        <input type="text" placeholder="  Enter your message..." id="button-caption" name="button-caption"value="<?php echo $viewcontact->buttoncaption;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($viewcontact->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewcontact->background);?>">
                        <?php }?>
                    </div>
                </div>
            </div>
