    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                <h2 class="Header-form">About Us</h2>
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                <form action="<?php echo site_url('admin/updateaboutuspage/'.$editaboutus->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your message..." id="heading" name="heading" value="<?php echo $editaboutus->heading;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($editaboutus->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editaboutus->background);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Title</label>
                        <input type="text" placeholder="  Enter your message..." id="title" name="title" value="<?php echo $editaboutus->title;?>">
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content" value="<?php echo $editaboutus->content;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo" name="image">
                        <?php if($editaboutus->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editaboutus->image);?>">
                        <?php }?>
                    </div>
