            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        ...
                        <input type="text" placeholder="  Enter your message..." id="recipe-title" name="recipe-title" value="<?php echo $viewdessert->recipetitle;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your name..." id="post-by" name="post-by" value="<?php echo $viewdessert->postby;?>">
                    </div>
                    <div class="row">
                        <label>Date</label>
                        <input type="date" placeholder="  Enter your message..." id="input" name="input" value="<?php echo $viewdessert->date;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo"name="image">
                        <?php if($viewdessert->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewdessert->image);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content" value="<?php echo $viewdessert->content;?>">
                    </div>
                </div>
            </div>
              <!-- Main container end -->
