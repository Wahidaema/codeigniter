    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <h2 class="Header-form">Welcome to Admin Panel</h2>
                ...
                <?php
                     foreach($fetchrecipefooter as $recipefooter){
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $recipefooter->id;?></th>
                        <td><?php echo substr ($recipefooter->content,0,50);?>...</td>
                        <td><?php echo substr ($recipefooter->postby,0,10);?></td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$recipefooter->background;?>"></td>
                        <td><?php echo substr ($recipefooter->paragraph,0,50);?>...</td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editrecipefooter/'.$recipefooter->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewrecipefooter/'.$recipefooter->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
