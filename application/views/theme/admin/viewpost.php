            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        ...
                        <input type="text" placeholder="  Enter your message..." id="recipe-title" name="recipe-title"value="<?php echo $viewpost->recipetitle;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your name..." id="post-by" name="post-by"value="<?php echo $viewpost->postby;?>">
                    </div>
                    <div class="row">
                        <label>Date</label>
                        <input type="date" placeholder="  Enter your message..." id="input" name="input"value="<?php echo $viewpost->date;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo"name="image">
                        <?php if($viewpost->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'. $viewpost->image);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Equipment</label>
                        <input type="text" placeholder="  Enter Your messeage..." id="equipment" name="equipment"value="<?php echo $viewpost->equipment;?>">
                    </div>
                    <div class="row">
                        <label>Ingredients</label>
                        <input type="text" placeholder="  Enter Your messeage..." id="ingredients" name="ingredients"value="<?php echo $viewpost->ingredients;?>">
                    </div>
                    <div class="row">
                        <label>Instructions</label>
                        <input type="text" placeholder="  Enter Your messeage..." id="instructions" name="instructions"value="<?php echo $viewpost->instructions;?>">
                    </div>
                </div>
            </div>
              <!-- Main container end -->
