            ...
            <div class="main-container"style="height:900px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo substr ($message->name,0,10);?></td>
                        <td><?php echo $message->email;?></td>
                        <td><?php echo substr ($message->message,0,50);?>...</td>
   
                       
                       <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/deletemessage/'.$message->id)?>"role="button">Delete</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewmessage/'.$message->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
