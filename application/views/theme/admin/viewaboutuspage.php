        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your message..." id="heading" name="heading" value="<?php echo $viewaboutus->heading;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($viewaboutus->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewaboutus->background);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Title</label>
                        <input type="text" placeholder="  Enter your message..." id="title" name="title" value="<?php echo $viewaboutus->title;?>">
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content" value="<?php echo $viewaboutus->content;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo" name="image">
                        <?php if($viewaboutus->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewaboutus->image);?>">
                        <?php }?>
                    </div>
                </div>
            </div>
