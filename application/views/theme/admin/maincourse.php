    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <button><a class="btn btn-warning btn-sm" href="http://localhost/codeigniter/addmaincourse">Add Main Course</a></button>
                ...
                <?php
                     foreach($fetchmain as $main){
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $main->id;?></th>
                        <td><?php echo substr ($main->recipetitle,0,10);?></td>
                        <td><?php echo substr ($main->postby,0,10);?></td>
                        <td><?php echo $main->date;?></td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$main->image;?>"></td>
                        <td><?php echo substr ($main->content,0,50);?>...</td>
                        <td><?php echo substr ($main->buttoncaption,0,10);?></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editmaincourse/'.$main->id)?>">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/deletemain/'.$main->id)?>">Delete</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewmaincourse/'.$main->id)?>">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
