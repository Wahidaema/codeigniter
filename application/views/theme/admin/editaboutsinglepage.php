    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <form action="<?php echo site_url('admin/updateaboutsinglepage/'.$editaboutsingle->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Author Name</label>
                        <input type="text" placeholder="  Enter your message..." id="author-name" name="author-name" value="<?php echo $editaboutsingle->authorname;?>">
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content" value="<?php echo $editaboutsingle->content;?>">
                    </div>
                    <div class="row">
                        <label>Profile</label>
                        <input type="file" class="photo" name="profile">
                        <?php if($editaboutsingle->profile){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editaboutsingle->profile);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Button Caption</label>
                        <input type="text" placeholder="  Enter your message..." id="button-caption" name="button-caption" value="<?php echo $editaboutsingle->buttoncaption;?>">
                    </div>
