    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <form action="<?php base_url()?>saveaboutsingle" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Author Name</label>
                        <input type="text" placeholder="  Enter your message..." id="author-name" name="author-name">
                    </div>
                    <div class="row">
                        <label>Content</label>
