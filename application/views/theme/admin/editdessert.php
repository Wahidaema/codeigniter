    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                <h2 class="Header-form">Dessert</h2>
                <div class="box"style="height:600px;width:900px;margin-left:50px;">
                <form action="<?php echo site_url('admin/updatedessert/'.$editdessert->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Recipe-Title</label>
                        <input type="text" placeholder="  Enter your message..." id="recipe-title" name="recipe-title" value="<?php echo $editdessert->recipetitle;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your name..." id="post-by" name="post-by" value="<?php echo $editdessert->postby;?>">
                    </div>
                    <div class="row">
                        <label>Date</label>
                        <input type="date" placeholder="  Enter your message..." id="input" name="input" value="<?php echo $editdessert->date;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo"name="image">
                        <?php if($editdessert->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editdessert->image);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content" value="<?php echo $editdessert->content;?>">
                    </div>
