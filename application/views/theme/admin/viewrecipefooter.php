        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content"value="<?php echo $viewrecipefooter->content;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your message..." id="post-by" name="post-by"value="<?php echo $viewrecipefooter->postby;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($viewrecipefooter->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewrecipefooter->background);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Paragraph</label>
                        <input type="text" placeholder="  Enter your message..." id="paragraph" name="paragraph"value="<?php echo $viewrecipefooter->paragraph;?>">
                    </div>
                </div>
            </div>
              <!-- Main container end -->
