        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Heading</label>
                        <input type="text" placeholder="  Enter your message..." id="heading" name="heading"value="<?php echo $viewrecipe->heading;?>">
                    </div>
                    <div class="row">
                        <label>Background</label>
                        <input type="file" class="photo"name="background">
                        <?php if($viewrecipe->background){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewrecipe->background);?>">
                        <?php }?>
                    </div>
                </div>
            </div>
