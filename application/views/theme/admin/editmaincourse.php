    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                <h2 class="Header-form">Main Course</h2>
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                <form action="<?php echo site_url('admin/updatemain/'.$editmaincourse->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Recipe-Title</label>
                        <input type="text" placeholder="  Enter your message..." id="recipe-title" name="recipe-title"value="<?php echo $editmaincourse->recipetitle;?>">
                    </div>
                    <div class="row">
                        <label>Post by</label>
                        <input type="text" placeholder="  Enter your message..." id="post-by" name="post-by"value="<?php echo $editmaincourse->postby;?>">
                    </div>
                    <div class="row">
                        <label>Date</label>
                        <input type="date" placeholder="  Enter your message..." id="input" name="input"value="<?php echo $editmaincourse->date;?>">
                    </div>
                    <div class="row">
                        <label>Image</label>
                        <input type="file" class="photo"name="image">
                        <?php if($editmaincourse->image){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$editmaincourse->image);?>">
                        <?php }?>
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content"value="<?php echo $editmaincourse->content;?>">
                    </div>
                    <div class="row">
                        <label>Button-Caption</label>
                        <input type="text" placeholder="  Enter your message..." id="button-caption" name="button-caption"value="<?php echo $editmaincourse->buttoncaption;?>">
                    </div>
