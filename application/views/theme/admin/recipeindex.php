    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:900px;">
                ...
                <?php
                     foreach($fetchrecipe as $recipe){
                ?>
                <tbody>
                    <tr>
                        <th scope="row"><?php echo $recipe->id;?></th>
                        <td><?php echo substr ($recipe->heading,0,10);?></td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$recipe->background;?>"></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editrecipe/'.$recipe->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewrecipe/'.$recipe->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
