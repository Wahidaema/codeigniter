        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your message..." id="name" name="name"value="<?php echo $viewteam->name;?>">
                    </div>
                    <div class="row">
                        <label>Position</label>
                        <input type="text" placeholder="  Enter your message..." id="title" name="title"value="<?php echo $viewteam->position;?>">
                    </div>
                    <div class="row">
                        <label>Content</label>
                        <input type="text" placeholder="  Enter your message..." id="content" name="content"value="<?php echo $viewteam->content;?>">
                    </div>
                    <div class="row">
                        <label>Profile</label>
                        <input type="file" class="photo"name="profile">
                        <?php if($viewteam->profile){?>
                        <img width="20%" src="<?php echo site_url('asset/uploads/'.$viewteam->profile);?>">
                        <?php }?>
                    </div>
                </div>
            </div>
