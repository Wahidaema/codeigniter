            ...
            <div class="main-container"style="height:700px;">
                ...
                <div class="box"style="height:580px;width:900px;margin-left:50px;">
                    <div class="row">
                        ...
                        <input type="text" placeholder="  Enter your message..." id="name" name="name" value="<?php echo $viewauthor->username;?>">
                    </div>
                    <div class="row">
                    <div class="row">
                        <label>name</label>
                        <input type="text" placeholder="  Enter your message..." id="name" name="name" value="<?php echo $viewauthor->name;?>">
                    </div>
                    <div class="row">
                        <label>email</label>
                        <input type="text" placeholder="  Enter your message..." id="email" name="email" value="<?php echo $viewauthor->email;?>">
                    </div>
                    <div class="row">
                        <label>password</label>
                        <input type="text" placeholder="  Enter your message..." id="password" name="password" value="<?php echo $viewauthor->password;?>">
                    </div>
