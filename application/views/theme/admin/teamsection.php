            ...
            <div class="main-container"style="height:900px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo substr ($team->position,0,10);?></td>
                        <td><?php echo substr ($team->content,0,50);?>...</td>
                        <td><img width="50px" src="<?php echo base_url().'asset/uploads/'.$team->profile;?>"></td>
                        <td>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/editteam/'.$team->id)?>"role="button">Edit</a>
                        <a class="btn btn-outline-warning btn-sm" href="<?php echo site_url('admin/viewteam/'.$team->id)?>"role="button">View</a></td>
                    </tr>   
                    <?php
                  }
                ?>        
