    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main-container"style="height:700px;">
                ...
                <form action="<?php echo site_url('admin/updatemessage/'.$editmessage->id);?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <label>Name</label>
                        <input type="text" placeholder="  Enter your Name..." id="name" name="name"value="<?php echo $editmessage->name;?>">
                    </div>
                    <div class="row">
                        <label>Email</label>
                        <input type="email" placeholder="  Enter your Email..." id="email" name="email"value="<?php echo $editmessage->email;?>">
                    </div>
                    <div class="row">
                        <label>Message</label>
                        <input type="text" placeholder="  Enter your message..." id="message" name="message"value="<?php echo $editmessage->message;?>">
                    </div>
